...
@section('content')
    ...
    <div class="edit-header">
        <div style="float:left;margin-left:25px;margin-top:15px;"><img src="{{URL('/images/backend/menu/projects.png')}}"></div><h1 style="float:left;margin-left:10px;">Project management</h1>
